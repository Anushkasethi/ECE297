...
static constexpr color BACKGROUND(0xE8, 0xEA, 0xED);
static constexpr color BACKGROUND_DARK(0x24, 0x2F, 0x3E);

static constexpr color TEXT(0x4E, 0x52, 0x56);
static constexpr color TEXT_DARK(0xFF, 0xFF, 0x00);

static constexpr color HIGHWAY(0xFD, 0xE2, 0x93);
static constexpr color HIGHWAY_DARK(0x74, 0x68, 0x55);
static constexpr color MAJOR_MINOR(0xFF, 0xFF, 0xFF);
static constexpr color MAJOR_MINOR_DARK(0xAA, 0xAA, 0xAA);

static constexpr color HIGHLIGHT(0xE1, 0x51, 0x42);

static constexpr color GREEN_DARK(0x26, 0x3C, 0x3F);

static constexpr color RIVER_DARK(0x17, 0x26, 0x3C);
